...
/// <summary>
/// Represents configuration options related to the polling of new messages.
/// </summary>
public class PollOptions : ITaskExecutionOptions
{
    internal const string Section = "Poll";
