...
/// <summary>
/// Represents configuration options related to the expiration of failed messages.
/// </summary>
public class ExpireFailedOptions : ITaskExecutionOptions
{
    internal const string Section = "ExpireFailed";
